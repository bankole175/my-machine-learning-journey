...
report = classification_report(all_labels, all_preds, target_names=['Class 0', 'Class 1', 'Class 2', 'Class 3', 'Class 4', 'Class 5', 'Class 6', 'Class 7', 'Class 8', 'Class 9'])
print(report)
...
print(f"Predicted: {predicted} ({confidence:.1%} confident)")
...
}, "digit_checkpoint.pth")

checkpoint = torch.load("digit_checkpoint.pth")
